...
var Optimizer = /** @class */ (function (_super) {
    ...
    function Optimizer(nodes, edges, ignoreByType, logger) {
        var _this = _super.call(this, nodes, edges, logger, ignoreByType) || this;
        _this.DependencyWidth = 30;
        _this.DependencyHeight = 30;
        _this.field = {};
        _this.myWidth = 12000;
        _this.myHeight = 12000;
        return _this;
    }
    Optimizer.prototype.destroy = function () {
        _super.prototype.destroy.call(this);
        this.field = {};
    };
    Optimizer.prototype.GenerateRandomSolution = function () {
        var lines = []; // TODO: Annotate me
        var i = 0;
        for (var i = 0; i < this.myAllNodes.length; i++) {
            this.InsertNodeAtGoodPosition(this.myAllNodes[i], lines);
        }
    };
    Optimizer.prototype.UpdateFieldColision = function (x, y, value) {
        if (value === void 0) { value = 1; }
        this.field[y * this.myWidth + x] = value;
    };
    Optimizer.prototype.InsertNodeAtGoodPosition = function (n, lines, iterations) {
     ...
     */
    Optimizer.prototype.ccw = function (x1, y1, x2, y2, x3, y3) {
        // TODO: Move to utils?
    ...
    Optimizer.prototype.findRandomPath = function (startNode) {
    ...
    Optimizer.prototype.waterDrivenLayout = function (iterations, spacingValue, gravity, ignoreEdgesByType, edgesIn) {
        if (gravity === void 0) { gravity = 200; }
    ...
    Optimizer.prototype.weaklyHierarchicalLayout = function (iterations, spacingValue, usingMinMax, currTemperature, initialStep) {
        if (usingMinMax === void 0) { usingMinMax = false; }
        if (currTemperature === void 0) { currTemperature = 0.9; }
        if (initialStep === void 0) { initialStep = 30.0; }
        for (var j = 0; j < this.myAllNodes.length; j++) {
            var n = this.myAllNodes[j];
            n.overallLength = 0;
            n.overallVisited = 0;
        ...
        var upDown = true; // TODO: why is this constant?
        for (var i = 0; i < this.myAllNodes.length; i++) {
    ...
    Optimizer.prototype.SolveUsingForces = function (iterations, spacingValue, resetForcesFixed, usingMinMax, currTemperature, initialStep, useGravity) {
        if (resetForcesFixed === void 0) { resetForcesFixed = true; }
        if (usingMinMax === void 0) { usingMinMax = false; }
        if (currTemperature === void 0) { currTemperature = 0.9; }
        if (initialStep === void 0) { initialStep = 30.0; }
    ...
    Optimizer.prototype.placeGraphs = function () {
    ...
    Optimizer.prototype.GetLineColision = function (currLine, lines) {
        var colision = 0;
